...
import HeatEfficiencyBeforeHeatMap from '../../src/components/graphs/HeatEfficiencyBeforeHeatMap';
...
// Sample test data for the HeatEfficiencyBeforeHeatMap component
// Assuming the data structure is the same as the after heatmap
const heatData = [
  {
    "LSOA11CD": "E01000001",
...
describe('HeatEfficiencyBeforeHeatMap', () => {
    ...
    it('renders the title correctly', () => {
      ...
      // When
      const titleElement = screen.getByText(/Total heat demand before energy efficiency measures 2018 \(kWh\)/i);
