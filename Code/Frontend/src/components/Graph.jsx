...
export default function Graph() {
    ...
    return (
        <DropdownButton id="dropdown-basic-button" title="Visualisation Graphs">
            ...
            <Dropdown.Item href="#">Half-hourly heat production and gas consuumption profiles - Gas boilers</Dropdown.Item>
            <Dropdown.Item href="#">Half-hourly heat production and gas consuumption profiles - Resistance heaters</Dropdown.Item>
